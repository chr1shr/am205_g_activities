...
// *************************************************************************************************
// Simple example of of references and pointers
...
int main(){
    ...
    *np = 999;
    ...
    np = &secondNumber;
    printf("After changing pointer to point to second number, first number = %d, second number = %d, "
           "and  pointer points to %d\n", number, secondNumber, (int) *np);
}
